...
import { DEMO_CREDENTIALS } from '@/admin/services/auth'
    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-12">
      <div className="w-full max-w-[420px] animate-fade-up">
        <div className="mb-8 flex flex-col items-center text-center">
          <img src="/admin/radium-logo-light.svg" alt="Radium" className="h-11 w-auto dark:hidden" />
          <img src="/admin/radium-logo-dark.svg" alt="Radium" className="hidden h-11 w-auto dark:block" />
        ...
        <p className="mt-6 text-center text-[12px] text-muted-foreground">
          Signed in against the Radium API.
        </p>
      </div>
    </div>
  )
