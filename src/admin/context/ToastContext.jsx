...
import { cn, uid } from '@/admin/utils'
...
const TONES = {
  ...
  info: 'border-black/20 dark:border-white/20 text-foreground/80',
}
          ...
          {toasts.map((t) => {
            ...
            return (
              <motion.div
                ...
                className={cn(
                  'pointer-events-auto flex items-start gap-3 rounded-glass border bg-white/[.95] dark:bg-[rgba(30,12,14,.92)] p-4 shadow-card backdrop-blur-[12px]',
              ...
              >
                ...
                <button
                  ...
                  className="rounded-md p-1 text-muted-foreground transition-colors hover:bg-black/5 dark:hover:bg-white/5 hover:text-foreground"
                  aria-label="Dismiss"
                >
